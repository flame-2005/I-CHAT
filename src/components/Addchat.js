...
const Addchat = (props) => {
  ...
  const handleClick = (e) => {
    e.preventDefault();
    addChat(chat.discription,chat.font,chat.weight,chat.fontStrick,chat.hyperLink,chat.textLink,chat.codeSnippet,chat.codeBlock,chat.bulletList,chat.noList,users.name)
  }
